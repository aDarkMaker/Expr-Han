...
## 目录
- [函数式编程原理课程报告](#函数式编程原理课程报告)
  - [目录](#目录)
    - [Heapify 求解](#heapify-求解)
    - [1.1 问题需求](#11-问题需求)
    - [1.2 解题思路与代码](#12-解题思路与代码)
    - [1.3 遇到的问题及运行结果](#13-遇到的问题及运行结果)
    - [1.4 性能分析（树深度）](#14-性能分析树深度)
    - [1.5 Java 与 C++ 对比](#15-java-与-c-对比)
  - [2 高阶函数和多态类型](#2-高阶函数和多态类型)
  - [3 函数式拓展学习调研](#3-函数式拓展学习调研)
    - [3.1 函数式程序应用场景](#31-函数式程序应用场景)
    - [3.2 函数式特征延伸](#32-函数式特征延伸)
    - [3.3 高阶与多态函数](#33-高阶与多态函数)
  - [4 函数式编程学习建议与心得](#4-函数式编程学习建议与心得)
